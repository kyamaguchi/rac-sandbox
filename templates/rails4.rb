...
@recipes = ["core", "git", "railsapps", "setup", "email", "gems", "readme", "frontend", "models", "testing", "apps4", "init", "controllers", "views", "prelaunch", "saas", "routes", "extras"]
@prefs = {}
@gems = ["rails_admin", "figaro", "airbrake"]
...
say_wizard "Your new Rails app is ready. Time to run 'bundle install'."
   ...
   # $ rails new myapp -m templates/rails4.rb
   ...
   #     setup  Your operating system is darwin12.4.0.
